  ...
  en: {
    ...
    features: {
      ...
      items: [
        ...
        { title: "Secure by default", body: "Rate limiting, security headers, input validation — no API keys ever touch the browser." },
        { title: "Trained on your business", body: "One paragraph describing your business is all it takes. Tone, products, FAQs — dialed in." },
    ...
    how: {
      ...
      steps: [
        ...
        { t: "We configure & deploy", b: "Branding, prompts, colors — all wired up and deployed to your domain." },
    ...
    pricing: {
      ...
      plans: [
        { name: "Starter", price: "₾800", tag: "Small business", cta: "Get started", perks: ["Custom-branded bot", "Up to 1,000 chats/month", "FAQ training in Georgian", "1 language (KA or EN)", "3 months free hosting", "Email support"] },
        { name: "Growth", price: "₾1,500", tag: "Most popular", featured: true, cta: "Get started", perks: ["Everything in Starter", "Lead capture → your email", "Up to 3 languages (KA/EN/RU)", "Custom tone & voice", "6 months free hosting", "Priority support"] },
        { name: "Premium", price: "₾3,000+", tag: "Enterprise", cta: "Contact us", perks: ["Everything in Growth", "CRM integration", "White-label deployment", "Multilingual training", "12 months hosting + SLA", "Dedicated support"] },
      ],
    },
    contact: {
      heading: "Let's talk",
  ...
  ka: {
    ...
    features: {
      ...
      items: [
        ...
        { title: "უსაფრთხოება პირველ რიგში", body: "Rate limiting, security headers, input validation — API კოდები არასდროს იხილავს ბრაუზერი." },
        { title: "თქვენი ბიზნესისთვის მორგებული", body: "ერთი აბზაცი თქვენი ბიზნესის შესახებ და სტილი, FAQ-ები, პროდუქტები — ყველაფერი ადგილზეა." },
        ...
        { title: "ერთ დღეში გაშვება", body: "ჩვენ ვაყენებთ, Vercel-ზე ვdeploy-ავთ და ერთი ხაზი გრჩება საიტზე ჩასასმელად." },
      ],
    },
    how: {
      ...
      steps: [
        ...
        { t: "ჩვენ ვაკონფიგურებთ და ვdeploy-ავთ", b: "ბრენდინგი, prompt-ები, ფერები — ყველაფერი ჩართულია და თქვენს დომენზე მუშაობს." },
    ...
    usecases: {
      ...
      items: [
        ...
        { e: "🏢", t: "SaaS და სააგენტოები", b: "აცნობს მომხმარებლებს პროდუქტს, მართავს პირველადი დონის მხარდაჭერას, ამოწმებს demo requests-ებს." },
      ],
    },
    pricing: {
      ...
      plans: [
        { name: "Starter", price: "₾800", tag: "პატარა ბიზნესი", cta: "დაიწყეთ", perks: ["ბრენდირებული ჩატბოტი", "1,000 საუბრამდე/თვეში", "FAQ ტრენინგი ქართულად", "1 ენა (KA ან EN)", "3 თვე უფასო hosting", "Email მხარდაჭერა"] },
        { name: "Growth", price: "₾1,500", tag: "ყველაზე პოპულარული", featured: true, cta: "დაიწყეთ", perks: ["ყველაფერი Starter-ში", "Lead-ები → თქვენს იმეილზე", "3 ენამდე (KA/EN/RU)", "Custom სტილი და ხმა", "6 თვე უფასო hosting", "პრიორიტეტული მხარდაჭერა"] },
        { name: "Premium", price: "₾3,000+", tag: "Enterprise", cta: "დაგვიკავშირდით", perks: ["ყველაფერი Growth-ში", "CRM ინტეგრაცია", "White-label deploy", "მრავალენოვანი ტრენინგი", "12 თვე hosting + SLA", "გამოყოფილი მხარდაჭერა"] },
      ],
    },
    contact: {
    ...
    return (
      <main className="h-screen flex items-center justify-center p-4 md:p-8">
        <div className="w-full max-w-3xl h-full max-h-[820px]">
          <ChatWindow darkMode={darkMode} onToggleDark={toggleDark} config={chatConfig} />
        </div>
      </main>
    );
  }
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
        ...
        <div className="absolute top-[30%] right-[-15%] w-[600px] h-[600px] bg-fuchsia-600/20 rounded-full blur-3xl animate-blob" style={{ animationDelay: "-5s" }} />
        <div className="absolute bottom-[-20%] left-[20%] w-[500px] h-[500px] bg-indigo-600/20 rounded-full blur-3xl animate-blob" style={{ animationDelay: "-9s" }} />
      </div>
      ...
      <header className="sticky top-0 z-40 backdrop-blur-xl bg-[#07070c]/70 border-b border-white/5">
        <nav className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
          <div className="flex items-center gap-2">
            ...
            <span className="ml-1 text-[10px] font-medium px-1.5 py-0.5 rounded bg-violet-500/15 text-violet-300 ring-1 ring-violet-400/20">🇬🇪 KA·EN·RU</span>
          </div>

          <div className="hidden md:flex items-center gap-8 text-sm text-gray-400">
            <a href="#features" className="hover:text-violet-300 transition">{t.nav.features}</a>
            <a href="#how" className="hover:text-violet-300 transition">{t.nav.how}</a>
            <a href="#usecases" className="hover:text-violet-300 transition">{t.nav.usecases}</a>
            <a href="#pricing" className="hover:text-violet-300 transition">{t.nav.pricing}</a>
            <a href="#contact" className="hover:text-violet-300 transition">{t.nav.contact}</a>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-6 pt-16 md:pt-24 pb-16">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-in">
            ...
            <p className="mt-5 text-lg text-gray-400 leading-relaxed max-w-xl">{t.hero.sub}</p>

            <div className="mt-8 flex flex-wrap gap-3">
              <a href="#demo" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-medium shadow-card hover:shadow-glow hover:-translate-y-[1px] transition">
                {t.hero.ctaPrimary} <ArrowRight size={16} />
              </a>
              <a href="#pricing" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl border border-white/10 bg-white/[0.03] text-gray-200 font-medium hover:border-violet-500/50 hover:bg-white/[0.06] transition">
                {t.hero.ctaSecondary}
              </a>
            </div>
      ...
      <section className="border-y border-white/5 bg-white/[0.02] backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-6 py-10 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          {t.stats.map((s, i) => (
            <div key={i}>
              <div className="text-2xl md:text-3xl font-semibold bg-gradient-to-r from-violet-400 to-fuchsia-400 bg-clip-text text-transparent">{s.v}</div>
              <div className="mt-1 text-xs text-gray-400 uppercase tracking-wider">{s.l}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      <section id="features" className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center max-w-2xl mx-auto mb-14">
          <h2 className="text-3xl md:text-4xl font-semibold tracking-tight">{t.features.heading}</h2>
          <p className="mt-4 text-gray-400">{t.features.sub}</p>
        </div>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {t.features.items.map((f, i) => {
            const Icons = [Globe, Zap, Shield, MessageSquare, TrendingUp, Clock];
            const Icon = Icons[i] || Sparkles;
            return (
              <div key={f.title} className="group relative p-6 rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/10 hover:border-violet-500/40 hover:bg-white/[0.05] hover:-translate-y-0.5 transition">
      ...
      <section id="how" className="max-w-5xl mx-auto px-6 py-20">
        <div className="text-center mb-14">
          <h2 className="text-3xl md:text-4xl font-semibold tracking-tight">{t.how.heading}</h2>
        </div>
        <div className="grid md:grid-cols-3 gap-6">
          {t.how.steps.map((s, i) => (
            <div key={i} className="relative p-6 rounded-2xl bg-white/[0.03] border border-white/10">
              <div className="text-xs font-mono text-violet-300">{String(i + 1).padStart(2, "0")}</div>
              <h3 className="mt-2 font-semibold">{s.t}</h3>
              <p className="mt-2 text-sm text-gray-400 leading-relaxed">{s.b}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section id="usecases" className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center max-w-2xl mx-auto mb-14">
          <h2 className="text-3xl md:text-4xl font-semibold tracking-tight">{t.usecases.heading}</h2>
          <p className="mt-4 text-gray-400">{t.usecases.sub}</p>
        </div>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {t.usecases.items.map((u) => (
            <div key={u.t} className="group relative p-6 rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/10 hover:border-violet-500/40 hover:bg-white/[0.05] hover:-translate-y-0.5 transition">
              <div className="text-3xl mb-3">{u.e}</div>
              <h3 className="font-semibold tracking-tight">{u.t}</h3>
              <p className="mt-2 text-sm text-gray-400 leading-relaxed">{u.b}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section id="pricing" className="max-w-6xl mx-auto px-6 py-20">
        <div className="text-center max-w-2xl mx-auto mb-14">
          <h2 className="text-3xl md:text-4xl font-semibold tracking-tight">{t.pricing.heading}</h2>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {t.pricing.plans.map((p) => (
            ...
            >
              ...
              <div className={`text-xs uppercase tracking-wider ${p.featured ? "text-violet-100" : "text-gray-400"}`}>{p.tag}</div>
              <h3 className={`mt-2 text-xl font-semibold ${p.featured ? "text-white" : ""}`}>{p.name}</h3>
              <div className="mt-4 flex items-baseline gap-1">
                <span className={`text-4xl font-semibold ${p.featured ? "text-white" : ""}`}>{p.price}</span>
                <span className={`text-sm ${p.featured ? "text-violet-100" : "text-gray-400"}`}>{t.pricing.oneTime}</span>
              </div>
              <p className={`mt-1 text-xs ${p.featured ? "text-violet-100" : "text-gray-500"}`}>{t.pricing.plusMonthly}</p>
              <ul className="mt-6 space-y-2.5">
                {p.perks.map((perk) => (
                  <li key={perk} className="flex items-start gap-2 text-sm">
                    <Check size={15} className={`mt-0.5 flex-shrink-0 ${p.featured ? "text-white" : "text-violet-300"}`} />
                    <span className={p.featured ? "text-violet-50" : "text-gray-300"}>{perk}</span>
                  </li>
                ))}
              </ul>
              <a
      ...
      <section id="contact" className="max-w-5xl mx-auto px-6 py-20">
        <div className="text-center max-w-2xl mx-auto mb-12">
          <h2 className="text-3xl md:text-4xl font-semibold tracking-tight">{t.contact.heading}</h2>
          <p className="mt-4 text-gray-400">{t.contact.sub}</p>
        </div>
        <div className="grid sm:grid-cols-2 gap-4">
          <ContactRow icon={Mail} label={t.contact.emailLabel} value={contact.email} href={`mailto:${contact.email}`} copied={t.contact.copied} />
          <ContactRow icon={Phone} label={t.contact.phoneLabel} value={contact.phone} href={`tel:${contact.phone.replace(/\s/g, "")}`} copied={t.contact.copied} />
          <ContactRow icon={Send} label={t.contact.telegramLabel} value={contact.telegram} href={`https://t.me/${contact.telegram.replace("@", "")}`} copied={t.contact.copied} />
          <ContactRow icon={Globe} label={t.contact.linkedinLabel} value={contact.linkedin} href={`https://${contact.linkedin}`} copied={t.contact.copied} />
        </div>
      </section>
      ...
      <section className="max-w-5xl mx-auto px-6 py-20">
        <div className="text-center max-w-2xl mx-auto mb-12">
          <h2 className="text-3xl md:text-4xl font-semibold tracking-tight">{t.payment.heading}</h2>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="p-6 rounded-2xl bg-white/[0.03] border border-white/10">
            ...
            <dl className="space-y-3 text-sm">
              <PayRow k={t.payment.beneficiary} v={payment.beneficiary} copied={t.contact.copied} />
              <PayRow k={t.payment.bankName} v={payment.bankName} copied={t.contact.copied} />
              <PayRow k={t.payment.iban} v={payment.iban} mono copied={t.contact.copied} />
            </dl>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-white/[0.03] border border-white/10">
            ...
            <dl className="space-y-3 text-sm">
              ...
              <PayRow k="Revolut" v={payment.revolut} copied={t.contact.copied} />
            </dl>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-violet-600 via-fuchsia-600 to-indigo-600 px-8 py-16 md:p-16 text-center shadow-glow">
          ...
          <div className="relative">
            <h2 className="text-3xl md:text-4xl font-semibold tracking-tight text-white">{t.cta.heading}</h2>
            <p className="mt-4 text-violet-100 max-w-xl mx-auto">{t.cta.sub}</p>
            <a href="#contact" className="mt-8 inline-flex items-center gap-2 px-8 py-3.5 rounded-xl bg-white text-violet-700 font-semibold hover:bg-violet-50 transition shadow-lg">
  ...
  return (
    <div className="group flex items-center gap-3 p-4 rounded-2xl bg-white/[0.03] border border-white/10 hover:border-violet-500/40 hover:bg-white/[0.05] transition">
      ...
      <div className="flex-1 min-w-0">
        ...
        <a href={href} target="_blank" rel="noopener noreferrer" className="text-sm text-gray-100 hover:text-violet-300 transition truncate block">
          {value}
        </a>
      </div>
      <button
...
function PayRow({ k, v, mono = false, copied: copiedLabel }) {
  ...
  return (
    <div className="flex items-center justify-between gap-3 py-2 border-b border-white/5 last:border-0">
      <dt className="text-gray-500 text-xs uppercase tracking-wider flex-shrink-0">{k}</dt>
      <dd className="flex items-center gap-2 min-w-0">
        <span className={`text-gray-100 truncate ${mono ? "font-mono text-xs" : "text-sm"}`}>{v}</span>
        <button onClick={copy} className="p-1.5 rounded-md text-gray-400 hover:text-violet-300 hover:bg-white/5 transition flex-shrink-0" title="Copy">
