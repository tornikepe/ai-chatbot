    ...
    features: {
      ...
      items: [
        ...
        },
        {
          ...
          body: "Rate limiting, security headers, input validation — API კოდები არასდროს იხილავს ბრაუზერი.",
        },
        {
          title: "თქვენი ბიზნესისთვის მორგებული",
          body: "ერთი აბზაცი თქვენი ბიზნესის შესახებ და სტილი, FAQ-ები, პროდუქტები — ყველაფერი ადგილზეა.",
        },
        {
        ...
        },
        {
          ...
          body: "ჩვენ ვაყენებთ, Vercel-ზე ვdeploy-ავთ და ერთი ხაზი გრჩება საიტზე ჩასასმელად.",
        },
      ],
    },
    how: {
      ...
      steps: [
        ...
        {
          t: "ჩვენ ვაკონფიგურებთ და ვdeploy-ავთ",
    ...
    usecases: {
      ...
      items: [
        ...
        },
        {
          ...
          b: "აცნობს მომხმარებლებს პროდუქტს, მართავს პირველადი დონის მხარდაჭერას, ამოწმებს demo requests-ებს.",
        },
      ],
    },
    pricing: {
